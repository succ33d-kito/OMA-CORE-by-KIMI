...
class BacktestEngine:
    ...
    EXPECTED_RETURNS = {
        ...
        "SHORT_SETUP": 2.8,
        "MOMENTUM_PLAY": 1.5,
        "AVOID_OR_SHORT": -5.0,         # Evitar pérdida = ganancia
        "SAFE_HAVEN_FLOW": 2.0,
        "RISK_OFF": 1.5,                # Reducir pérdida = ganancia
        "WHALE_ACCUMULATION": 4.0,
        "WHALE_DISTRIBUTION": -3.0,     # Evitar pérdida
        "VIRAL_MOMENTUM": -2.0,         # Pump and dump = pérdida
        "POST_EARNINGS_RUN": 2.5,
        "MACRO_TAILWIND": 3.0,
        "MACRO_HEADWIND": -2.0,
        "REGULATORY_TAILWIND": 2.5,
        "REGULATORY_HEADWIND": -4.0,
        "SENTIMENT_TURN_BULL": 2.0,
        "SENTIMENT_TURN_BEAR": -2.0,
        "ARB_OPPORTUNITY": 1.5,
        "WATCHLIST_ADD": 0.0,
        "NEWS_DRIVEN": 1.0,
        "TECHNICAL_BREAKOUT": 3.0,
        "TECHNICAL_BREAKDOWN": -2.5,
        "TECHNICAL_WATCH": 0.0,
        "WHALE_WATCH": 0.0,
    ...
    def run_backtest(self, hours: int = 168, min_score: float = 40.0) -> Dict:
        ...
        # Simular trades
        trades = [self._simulate_trade(opp) for opp in opportunities]
